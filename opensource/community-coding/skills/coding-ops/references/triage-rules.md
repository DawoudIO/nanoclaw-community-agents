...
`COMMUNITY_REPOS` lists the repos you actively triage — normally the ones with real external community activity, but it's the owner's call. If a repo you're expected to watch isn't in `COMMUNITY_REPOS`, ask your lead rather than assuming, and
