...
---
**If `status` is `fetch-failed`**: report to your manager — a `403` here almost
...
`plugin-data/community-helper/seen-advisories.txt` — that's your
...
Your manager routes disclosure per its own escalation rules.
