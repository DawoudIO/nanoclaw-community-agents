...
---
Write the daily dev metrics section for your manager's dev-facing report,
...
likely) — tell your manager which repos and that today's numbers for them are
...
is null two runs in a row, flag the likely token/policy problem to your manager.
...
delegation candidates — the Helper's `contributor-health-review` owns those,
...
Hand it to your manager — you don't post it to a channel yourself.
