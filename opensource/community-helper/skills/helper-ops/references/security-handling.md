...
an issue, not a channel, not a commit message. You hand it to your manager
privately and stop.
...
further in the open; it makes it more urgent to hand to your manager.

## Assessing a dependency alert

A forwarded CVE number is nearly useless on its own. What your manager needs:
...
- Hand it to your manager immediately, out of band from any routine digest — this
