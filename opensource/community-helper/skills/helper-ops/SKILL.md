...
may not compose freely. Read `references/reporting-to-manager.md` for the
boundary in detail.
...
4. **Anything you're about to send upward** → `references/reporting-to-manager.md`
...
- **Never take the irreversible action.** Closing, merging, labeling, publishing
  — all belong to a human or to your manager. You draft.
...
- **Content requests aren't yours, even as a draft.** Say content is
  owner-managed and hand the request to your manager.
