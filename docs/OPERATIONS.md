...
| `inbox-check` | Manager | **2× daily** | 06:55, 16:55 | yes |
...
_22 tasks across 2 agents; 21 script-gated (ungated: social-metrics-snapshot)_
...
Everything else is 0-token when there's nothing to judge — **19 of 22 tasks,
